 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Ctrl |  '"  | Alt  |      |  L1  |                                       | Left |  Up  | Down |Right |  _   |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LCTL,  KC_QUOT,     KC_LALT,KC_NO,  MO(SYMB),
                                               LGUI(KC_C), LGUI(KC_V),
                                                           LGUI(KC_X),
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_7,   KC_8,   KC_9,    KC_LPRN, KC_RPRN,
                KC_TRNS, KC_4,   KC_5,   KC_6,    KC_LCBR, KC_RCBR,
       KC_TRNS, KC_0,    KC_1,   KC_2,   KC_3,    KC_LBRC, KC_RBRC,
                         KC_0,   KC_DOT, KC_EQL,  KC_SLSH, M(M_AROW),
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
...
[MDIA] = KEYMAP(
       ...
       // right hand
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_TRNS, KC_TRNS, M(M_UENT),  KC_TRNS, KC_TRNS, KC_TRNS,
                 KC_F15,  KC_BSPC, KC_ENTER,   KC_DELT, KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_F16,  KC_TRNS, M(M_DENT),  KC_TRNS, KC_TRNS, KC_TRNS,
                          KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
