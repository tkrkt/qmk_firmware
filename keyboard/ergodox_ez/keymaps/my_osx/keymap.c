...
[SYMB] = KEYMAP(
       ...
       // right hand
       KC_TILD, KC_TRNS, KC_LABK, KC_RABK, KC_TRNS,   KC_TRNS, KC_TRNS,
       KC_AMPR, KC_TRNS, KC_LPRN, KC_RPRN, M(M_AROW), KC_TRNS, KC_TRNS,
                KC_TRNS, KC_LCBR, KC_RCBR, KC_TRNS,   KC_TRNS, KC_TRNS,
       KC_PIPE, KC_TRNS, KC_LBRC, KC_RBRC, KC_TRNS,   KC_TRNS, KC_TRNS,
...
[MDIA] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS,        M(M_UENT),  KC_TRNS, KC_TRNS, KC_F12,
                KC_F15,  KC_BSPC,        KC_ENTER,   KC_DELT, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_F16,  LSFT(KC_ENTER), M(M_DENT),  KC_TRNS, KC_TRNS, KC_TRNS,
                         KC_TRNS,        KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
 ...
 * | RESET  |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      | Lclk | MsUp | Rclk | Lclk | WhUp |           | WhUp | Lclk |  7   |  8   |  9   |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | ACL0   | ACL0 |MsLeft|MsDown|MsRght| Rclk |------|           |------| Rclk |  4   |  5   |  6   |      |        |
 * |--------+------+------+------+------+------| WhDn |           | WhDn |------+------+------+------+------+--------|
 * |        |      | WhUp | Cclk | WhDn |      |      |           |      |  0   |  1   |  2   |  3   |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |  0   |      |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[MUSE] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_BTN1, KC_MS_U, KC_BTN2, KC_BTN1, KC_WH_U,
       KC_ACL0, KC_ACL0, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN2,
    ...
    // right hand
       KC_TRNS,  KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,
       KC_WH_U,  KC_BTN1, KC_7,     KC_8,     KC_9,    KC_TRNS, KC_TRNS,
                 KC_BTN2, KC_4,     KC_5,     KC_6,    KC_TRNS, KC_TRNS,
       KC_WH_D,  KC_0,    KC_1,     KC_2,     KC_3,    KC_TRNS, KC_TRNS,
